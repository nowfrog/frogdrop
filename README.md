...
> **Note:** Windows may show a SmartScreen warning since the app isn't code-signed. Click "More info" → "Run anyway". This is normal for open-source apps.
...
- Drop a photo of a LEGO part → Claude identifies the **part number, color, and name**
- Automatically fetches **3D renders** from BrickLink/Rebrickable and adds them to your listing photos
- Bulk workflow: generate dozens of LEGO part listings at once with accurate part data
...
- Price and quantity
- Item specifics (auto-loaded from eBay based on category)
- Shipping options (service, cost, free shipping)
...
- **Left panel:** Your ready listings with all data (title, description, price, photos)
...
**11 languages:** English, Italian, German, Spanish, French, Japanese, Dutch, Polish, Portuguese, Swedish. Each store can generate listings in a different language.
...
Data includes: listings database, photos, platform sessions (Vinted/Wallapop/YouTube cookies), and app settings.
